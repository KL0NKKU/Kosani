  ...
  return (
    <div className="row gx-lg-8 align-items-center">
      ...
      <div className="order-lg-2 col-lg-6">
        <figure className="img-bg">
          <Image
            ...
            alt="Transforming Residential Construction in Location | Kosani Oy"
            width={600}
            height={700}
      ...
      <div className="order-lg-1 col-lg-6">
        {/* Section label */}
        <h3 className="fs-16 py-2 px-3 text-main d-inline rounded-pill oswald">Miksi valita meidät ?</h3>

        {/* Main headline */}
        <h2 className="mb-5 mt-3 justify-content-start oswald">
          LVI-palvelut eri tarpeisiin
