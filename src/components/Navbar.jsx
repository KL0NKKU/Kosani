  ...
  const headerContent = (
    <Fragment>
      ...
      <div className="navbar-brand w-100">
        <NextLink
          href="/"
          title={<Image unoptimized={true} alt="Logo | Kosani Oy" src="/img/logo.webp" width={190} height={70} />}
        />
      </div>
        ...
        <div className="offcanvas-body ms-lg-auto d-flex flex-column h-100 offcavas-bg">
          ...
          <ul className="navbar-nav align-items-lg-center">
            ...
            <li className="nav-item" data-bs-dismiss="offcanvas">
              <a href="#etusivu" className="nav-link">
                Etusivu
              </a>
            </li>
            <li className="nav-item" data-bs-dismiss="offcanvas">
              <a href="#tietoa-meista" className="nav-link">
                Tietoa meistä
              </a>
            </li>
            <li className="nav-item" data-bs-dismiss="offcanvas">
              <a href="#palvelut" className="nav-link">
                Palvelut
              </a>
            </li>
            <li className="nav-item" data-bs-dismiss="offcanvas">
              <a href="#ota-yhteytta" className="nav-link">
                Ota yhteyttä
              </a>
            </li>
          </ul>
